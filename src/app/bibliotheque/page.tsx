...
const FILTERS_STORAGE_KEY = "biblio-filters";
const SCROLL_STORAGE_KEY = "biblio-scroll";
...
export default function BibliothequePage() {
  ...
  }, [query, status, genres, readYear, sortKey, sortDir]);
  ...
  useEffect(() => {
    ...
    const onScroll = () => {
      ...
      raf = requestAnimationFrame(() => {
        raf = 0;
        try { sessionStorage.setItem(SCROLL_STORAGE_KEY, String(window.scrollY)); } catch { /* ignore */ }
      });
    };
  ...
  useEffect(() => {
    ...
    let y = 0;
    try { y = Number(sessionStorage.getItem(SCROLL_STORAGE_KEY) || 0); } catch { /* ignore */ }
